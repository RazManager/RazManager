...
{
    public class HeatWithoutStintService : Razmanager.Protobuf.Internal.Repository.SystemServices.HeatWithoutStint.HeatWithoutStintService.HeatWithoutStintServiceBase
    {
        ...
        public HeatWithoutStintService(Stores.Context.RepositoryDbContext dbContext,
        ...
        public override async Task<Razmanager.Protobuf.Public.V1.HeatWithoutStint> Read(StringValue request, ServerCallContext context)
        {
            ...
            var result = _mapper.Map<Razmanager.Protobuf.Public.V1.HeatWithoutStint>(entity);
