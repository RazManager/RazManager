...
builder.Services.AddGrpcClientWithoutAuthentication<Razmanager.Protobuf.Internal.Repository.SystemServices.HeatWithoutStint.HeatWithoutStintService.HeatWithoutStintServiceClient>(repositoryClientOptions.RepositoryClientAddress);
builder.Services.AddGrpcClientWithoutAuthentication<Razmanager.Protobuf.Internal.Repository.SystemServices.HeatWithStint.HeatWithStintService.HeatWithStintServiceClient>(repositoryClientOptions.RepositoryClientAddress);
builder.Services.AddGrpcClientWithoutAuthentication<Razmanager.Protobuf.Internal.Repository.SystemServices.HeatWithoutStint.HeatWithoutStintService.HeatWithoutStintServiceClient>(repositoryClientOptions.RepositoryClientAddress);
...
builder.Services.AddGrpcClientWithoutAuthentication<Razmanager.Protobuf.Internal.Repository.SystemServices.RaceSession.RaceSessionService.RaceSessionServiceClient>(repositoryClientOptions.RepositoryClientAddress);
