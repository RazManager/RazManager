...
namespace RazManager.Silo.Grains.Entities.Stint
{
    public interface IStintGrain : IGrainWithGuidKey
    {
        ...
        Task<Razmanager.Protobuf.Public.V1.DetailState> ReadStintStateAsync();
        Task CommandAsync(Razmanager.Protobuf.Public.V1.DetailCommandTypeId stintCommandTypeId);
