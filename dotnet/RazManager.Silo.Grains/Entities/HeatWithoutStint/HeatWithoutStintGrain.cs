...
{
    public class HeatWithoutStintGrain : HeatStintGrainBase, IHeatWithoutStintGrain
    {
        private readonly Razmanager.Protobuf.Internal.Repository.SystemServices.HeatWithoutStint.HeatWithoutStintService.HeatWithoutStintServiceClient _serviceClient;
        ...
        private Razmanager.Protobuf.Public.V1.HeatWithoutStint? _heatWithoutStint;
        ...
        private readonly ILogger<HeatWithoutStintGrain> _logger;


        public HeatWithoutStintGrain(Razmanager.Protobuf.Internal.Repository.SystemServices.Event.EventService.EventServiceClient eventServiceClient, 
                                     ...
                                     Razmanager.Protobuf.Internal.Repository.SystemServices.HeatWithoutStint.HeatWithoutStintService.HeatWithoutStintServiceClient serviceClient,
                                     ...
                                     ILogger<HeatWithoutStintGrain> logger) : base(eventServiceClient, raceServiceClient, raceSessionServiceClient, logger)
        {
        ...
        public override async Task OnActivateAsync(CancellationToken cancellationToken)
        {
            try
            {
                _heatWithoutStint = await _serviceClient.ReadAsync(new Google.Protobuf.WellKnownTypes.StringValue { Value = this.GetPrimaryKey().ToString() });
                raceSession = await raceSessionServiceClient.ReadAsync(new Google.Protobuf.WellKnownTypes.StringValue { Value = _heatWithoutStint.RaceSessionId });
                ...
                _heatWithoutStint!.HeatWithoutStintStateType = new Razmanager.Protobuf.Public.V1.DetailStateType
                {
                ...
                _heatWithoutStintStateStream = streamProvider.GetStream<DetailState>(Constants.StreamName.HeatWithoutStintState.ToString(), this.GetPrimaryKey());
                _heatWithoutStintLeaderboardStream = streamProvider.GetStream<HeatWithoutStintLeaderboard>(Constants.StreamName.HeatWithoutStintLeaderboard.ToString(), this.GetPrimaryKey());
                _heatAnalysesStream = streamProvider.GetStream<HeatAnalyses>(Constants.StreamName.HeatAnalyses.ToString(), this.GetPrimaryKey());
                foreach (var item in _heatWithoutStint!.HeatIndicators)
                {
        ...
        public async Task RefreshHeatIndicatorStintsAsync(Guid heatIndicatorId)
        {
            ...
            if (newHeat is not null) {
                ...
                var heatIndicator = _heatWithoutStint!.HeatIndicators.SingleOrDefault(x => new Guid(x.Id) == heatIndicatorId);
        ...
        protected override void InitializeIndicators()
        {
            ...
            foreach (var item in _heatWithoutStint!.HeatIndicators.OrderBy(x => x.IndicatorId).Select((indicator, index) => new { indicator, index }))
            {
                var heatStateIndicator = new IndicatorState
                {
                    Id = item.indicator.Id,
                    EventUserId = _heatWithoutStint!.HeatIndicators.SingleOrDefault(x => x.Id == item.indicator.Id)?.EventUserId,
                ...
                foreach (var otherItem in _heatWithoutStint!.HeatIndicators.OrderBy(x => x.IndicatorId).Where(x => x.IndicatorId != item.indicator.IndicatorId))
                {
        ...
        public Task<Razmanager.Protobuf.Public.V1.HeatWithoutStint> ReadAsync()
        {
            return Task.FromResult(_heatWithoutStint!);
        }


        public Task<Razmanager.Protobuf.Public.V1.DetailState> ReadHeatWithoutStintStateAsync()
        {
        ...
        public Task<Razmanager.Protobuf.Public.V1.HeatWithoutStintLeaderboard> ReadHeatWithoutStintLeaderboardAsync()
        {
            return Task.FromResult(HeatWithoutStintLeaderboard());
        }
        ...
        public Task<HeatStintEventUsers> ReadHeatStintEventUsersAsync()
        {
            ...
            foreach (var heatIndicator in _heatWithoutStint!.HeatIndicators)
            {
        ...
        protected override async Task RaiseHeatStintStateTypeAsync(Razmanager.Protobuf.Public.V1.DetailStateTypeId heatStintStateTypeId)
        {
            ...
            _ = GrainFactory.GetGrain<RaceSessionWithoutStint.IRaceSessionWithoutStintGrain>(
                new Guid(_heatWithoutStint!.RaceSessionId)).HeatWithoutStintStateTypeUpdatedAsync(_heatWithoutStint!);
                    ...
                    case DeviceConfigurationInputTypeId.StartFinishIndicatorIgnoreLapTime:
                        ...
                        if (!indicatorState.Finished)
                        {
                            ...
                            if (indicatorState.Laps.HasValue)
                            {
                                ...
                                var heatIndicatorStints = _heatWithoutStint?.HeatIndicators.SingleOrDefault(x => x.IndicatorId == indicatorId)?.HeatIndicatorStints;
                                ...
                                if (!replay)
                                {
                                    var eventUserId = _heatWithoutStint!.HeatIndicators.SingleOrDefault(x => x.Id == indicatorState.Id)?.EventUserId;
                                    if (eventUserId is not null)
                                    {
                                        ...
                                        var eventUserIdBehind = _heatWithoutStint!.HeatIndicators.SingleOrDefault(x => x.Id == heatStateIndicatorBehind?.Id)?.EventUserId;
                                        ...
                                        var eventUserIdAhead = _heatWithoutStint!.HeatIndicators.SingleOrDefault(x => x.Id == heatStateIndicatorAhead?.Id)?.EventUserId;
                                ...
                                if (!replay)
                                {
                                    var heatIndicator = _heatWithoutStint!.HeatIndicators.SingleOrDefault(x => x.IndicatorId == indicatorId);
        ...
        private async Task PublishStateAsync()
        {
            ...
            _ = _heatWithoutStintStateStream!.OnNextAsync(heatState);
            _ = _heatWithoutStintLeaderboardStream!.OnNextAsync(HeatWithoutStintLeaderboard());
        ...
        private HeatWithoutStintLeaderboard HeatWithoutStintLeaderboard()
        {
            var heatWithoutStintLeaderboard = new HeatWithoutStintLeaderboard
            {
            ...
            {
                var heatLeaderboardIndicator = new HeatWithoutStintLeaderboardIndicator
                {
                ...
                heatWithoutStintLeaderboard.Indicators.Add(heatLeaderboardIndicator);
            ...
            return heatWithoutStintLeaderboard;
        }
    }
}
