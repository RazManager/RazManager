...
@$pb.GrpcServiceName(
    'razmanager.protobuf.internal.repository.user_services.event.EventService')
class EventServiceClient extends $grpc.Client {
  ...
  static final _$select = $grpc.ClientMethod<$0.Empty, $1.EventSelectResponse>(
      '/razmanager.protobuf.internal.repository.user_services.event.EventService/Select',
