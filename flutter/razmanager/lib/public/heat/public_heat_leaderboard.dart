          ...
          Expanded(
            child: LayoutBuilder(
              builder: (context, constraints) {
                ...
                final indicatorColumns = publicHeatChildState.eventModel.leaderBoardIndicatorColumns;
                final indicatorMaxWidth = constraints.maxWidth / indicatorColumns - ((indicatorColumns - 1) * 16);
                final indicatorMaxRows = (publicHeatChildState.heatModel.heatProto!.heatIndicators.length / indicatorColumns).ceil();
                ...
                for (var i = 1; i <= publicHeatChildState.heatModel.heatProto!.heatIndicators.length; i++) {
                              ...
                              if (model.heatLeaderboard != null)
                                ...model.heatLeaderboard!.indicators.map((heatLeaderboardIndicator) {
                                  ...
                                  return AnimatedPositioned(
                                    ...
                                    // left: leftMargin,
                                    top: positions[heatLeaderboardIndicator.position]?.$2,
                                    left: positions[heatLeaderboardIndicator.position]?.$1,
                                    child: Container(
