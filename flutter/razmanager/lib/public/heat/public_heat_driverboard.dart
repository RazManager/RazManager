      ...
      builder: (_, eventModel, __) {
        ...
        switch (eventModel.driverBoardSelection) {
          ...
          case DriverBoardSelection.firsthalf:
            heatIndicators = heatModel.heatProto!.heatIndicators.getRange(0, middle);
            break;
        ...
        final refHeatUsersTeamOrDriversMaxWidth =
            publicHeatChildState.calculateHeatUsersTeamOrDriversMaxWidth(
              ...
              Expanded(
                child: LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    if (constraints.maxWidth / columns < 150) {
                      return Center(child: Text("Plase select fewer teams/drivers"));
                    } else {
                          ...
                          children: heatIndicators.map((heatIndicator) {
                            ...
                            return Card(
                              child: Padding(
                                ...
                                child: LayoutBuilder(
                                  builder: (context, constraints) {
                                    final showGaps = constraints.maxWidth > 400 && !eventModel.driverBoardMinimal;
