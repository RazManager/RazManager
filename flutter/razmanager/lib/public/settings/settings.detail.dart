...
class _SettingsDetailState extends State<SettingsDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Settings'), flexibleSpace: const AppProgressIndicator()),
            ...
            children: [
              DropdownButton(
                ...
                onChanged: (value) async {
                  if (value != null) {
                    settingsModel.setThemeDataColorSchemeSeed(value);
                    setState(() {});
                  }
                },
              ...
              RadioGroup<Brightness>(
                ...
                onChanged: (value) async {
                  if (value != null) {
                    await settingsModel.setThemeDataBrightness(value);
                    setState(() {});
                  }
                },
                child: Column(
                  children: [
                    RadioListTile(title: const Text('Light'), value: Brightness.light),
                    RadioListTile(title: const Text('Dark'), value: Brightness.dark),
                  ],
                ),
              ),
